package com.xaxage.recipeapp.bootstrap;

import com.xaxage.recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //Getting UOMs and checking if we really get the UOMs
        ...
        //Getting Categories and checking if we really get the categories
